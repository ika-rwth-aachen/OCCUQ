...
class LoadOccupancy(object):
    ...
    def __init__(self, use_semantic=True, ignore_label_ids=[0]):
        self.use_semantic = use_semantic
        self.ignore_label_ids = ignore_label_ids
        print("LoadOccupancy Ignore Cls IDs: ", ignore_label_ids)
    ...
    def __call__(self, results):
        ...
        if self.use_semantic:
            for ignore_label_id in self.ignore_label_ids:
                occ[..., 3][occ[..., 3] == ignore_label_id] = 255
        else:
            occ = occ[occ[..., 3] > 0]
            occ[..., 3] = 1
