...
def custom_multi_gpu_mcdropout_test(model, data_loader, tmpdir=None, gpu_collect=False, is_vis=False):
    """Test model with multiple gpus.
    This method tests model with multiple gpus and collects the results
    under two different modes: gpu and cpu modes. By setting 'gpu_collect=True'
    it encodes results to gpu tensors and use gpu communication for results
    ...
    for i, data in enumerate(data_loader):
        with torch.no_grad():
            ...
            result = model(return_loss=False, mcdropout=True, rescale=True, **data)
...
def custom_multi_gpu_deepensembles_test(model, data_loader, tmpdir=None, gpu_collect=False, is_vis=False):
    """Test model with multiple gpus.
    This method tests model with multiple gpus and collects the results
    under two different modes: gpu and cpu modes. By setting 'gpu_collect=True'
    it encodes results to gpu tensors and use gpu communication for results
    ...
    for i, data in enumerate(data_loader):
        with torch.no_grad():
            ...
            result = model(return_loss=False, deepensembles=True, rescale=True, **data)
